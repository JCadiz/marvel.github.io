        ...
        <div class="row karl-new-arrivals">
                    ...
                    <div class="col-12 col-sm-6 col-md-4 single_gallery_item women wow fadeInUpBig margen" data-wow-delay="0.2s">
                        ...
                        <div class="product-img">
                            <img src="{{ asset('gallery/' . $serie->imagen) }}" alt="{{ $serie->imagen }}">
                        ...
                        <div class="product-description">
                            <h2 class="product-price text-center">{{ $serie->title }}</h2>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-12 col-lg-5">
                            <div class="quickview_pro_img">
                                <img src="{{ asset('gallery/' . $serie->imagen) }}" alt="">
                            </div>
                        </div>
...
<div class="shop_pagination_area wow d-flex justify-content-center mb-4 fadeInUp" data-wow-delay="1.1s">
    <nav aria-label="Page navigation ">
        <ul class="pagination pagination-sm">
            <li class="page-item">
                <a class="page-link" href="{{ route('series2') }}">back</a>
            </li>
        </ul>
    </nav>
</div>
